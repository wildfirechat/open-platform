...
## 系统架构图
![架构图](https://static.wildfirechat.cn/open_arch.png)
...
![流程图](https://static.wildfirechat.cn/open_flow.png)
...
应用列表
![应用列表](https://static.wildfirechat.cn/open_admin_application_list.png)

创建应用
![创建应用](https://static.wildfirechat.cn/open_admin_create_application.png)

修改应用
![修改应用](https://static.wildfirechat.cn/open_admin_modify_application.png)

手机截图

<img src="https://static.wildfirechat.cn/open_admin_client.png" width = 50% height = 50% />
